      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 flex-wrap mb-8">
            <span className="px-4 py-2 bg-secondary rounded text-foreground">Home Decoration 12</span>
            <span className="px-4 py-2 bg-secondary rounded text-foreground">Office Decoration 40</span>
            <span className="px-4 py-2 bg-secondary rounded text-foreground">Indoor Decoration 60</span>
            <span className="px-4 py-2 bg-secondary rounded text-foreground">Outdoor Decoration 10</span>
          </div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product, index) => (
            <div key={index} className="bg-card rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-border">
              ...
              <div className="p-4">
                ...
                <p className="text-foreground/80 font-medium">
                  {product.priceRange ? `${product.price} – ${product.priceRange}` : product.price}
                </p>
